...
<head>
    ...
    <title>Login - BlueHaven Hotel</title>
...
<body class="min-h-screen flex items-center justify-center px-4">
    ...
    <div class="glass neon w-full max-w-md p-10 rounded-3xl shadow-2xl
        ...
        {{-- ERROR VALIDATION --}}
        @if ($errors->any())
            <div class="bg-red-400/60 text-white p-3 rounded-lg mb-4 text-sm shadow">
                {{ $errors->first() }}
            </div>
        @endif
        ...
        <p class="text-center mt-6 text-gray-900 font-medium">
            Belum punya akun?
            <a href="{{ route('register') }}" class="text-purple-700 font-bold hover:underline">
                Daftar Sekarang
            </a>
        </p>
    </div>
